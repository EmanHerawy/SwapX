...
contract AddLiquidityScript is Script {
    ...
    address constant MUNI_ADDRESS = address(0x3b39F2783760a2B0D318995fE20dB587e55cADdc); //mUNI deployed to GOERLI -- insert your own contract address here
    address constant MUSDC_ADDRESS = address(0x4Eea91fc9862c429D8dd8Ca471fc93568171fE2a); //mUSDC deployed to GOERLI -- insert your own contract address here
    address constant HOOK_ADDRESS = address(0x7174486cDD1E9cBecd977134A10d55f357A50Ac0); //address of the hook contract deployed to goerli -- you can use this hook address or deploy your own!

    PoolModifyLiquidityTest lpRouter = PoolModifyLiquidityTest(address(0xFB3e0C6F74eB1a21CC1Da29aeC80D2Dfe6C9a317)); //from here : https://notreadyyet.uniswapfoundation.org/reference/solidity-contracts/v4/deployment-addresses
